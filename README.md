...
| [`examples/`](./examples/)           | 23 realistic documents across fourteen unlike domains               |
| [`conformance/`](./conformance/)     | Language-agnostic conformance suite, 179 cases                      |
...
Thirty-two repository checks run on every change. They exist because a principle nobody can
...
✓ conformance-manifest     179 cases, all runnable
